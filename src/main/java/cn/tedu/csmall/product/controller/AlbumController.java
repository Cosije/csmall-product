...
//http://localhost:9080/album/add-new?name=TestAlbumName001&description=TestAlbumDescription001&sort=77
    @ApiOperation("添加相册")
    ...
    @ApiImplicitParam(name = "id",value = "相册id",required = true,dataType = "long")
    @PostMapping("/{id:[0-9]+}/delete/test")
